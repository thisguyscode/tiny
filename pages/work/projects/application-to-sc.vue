<template>
  <section>
    <div class="o-text-section">
      ...
      <l-wrapper size="sm">
        <h3 class="o-heading o-heading--gamma">A Quick Week</h3>
    ...
    <div class="o-text-section">
      <c-baselines></c-baselines>
      <l-wrapper size="sm">
        <h3 class="o-heading o-heading--gamma">Right to Education</h3>
    ...
    <c-box :border="true" :filled="true" :padded="true">
      <l-wrapper size="lg" class="u-text--align-center">
        <c-device-frame class="u-margin-bottom-sm">
          <c-image
            altText="Coloured map of India highlighting various data points"
    ...
    <c-box :border="true" :filled="true" :padded="true">
      <l-wrapper size="lg" class="u-text--align-center">
        <c-device-frame class="u-margin-bottom-sm">
          <c-image
            altText="The same map of India but everything looks a little better"
    ...
    <c-box :border="true" :filled="true" :padded="true">
      <l-wrapper size="lg" class="u-text--align-center">
        <c-device-frame class="u-margin-bottom-sm">
          <c-image
            altText="A full cup of water and text reading - The good news. Many districts across India now have access to drinking water in 100% of their schools"
    ...
    <div class="o-text-section">
      <c-baselines></c-baselines>
      <l-wrapper size="sm">
        <h3 class="o-heading o-heading--gamma">World Malaria Day</h3>
        ...
        <ol class="o-text o-text--paragraph">
          <li>
            An infographic - intended for sharing on social media (see below)
          </li>
          <li>
            <c-link externalLink="https://thisguyscode.github.io/malaria/" :inline="true">A microsite</c-link> (of course)
          </li>
          <li>
            <c-link externalLink="/files/SocialCops-Malaria.pdf" :inline="true">A printable PDF</c-link>
          </li>
        </ol>
      </l-wrapper>
    </div>
    ...
    <c-box :border="true" :filled="true" :padded="true">
      <l-wrapper size="sm" class="u-text--align-center">
        <c-image
          altText="An infographic depicting various data-points relating to malaria"
