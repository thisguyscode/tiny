  ...
  <section>
    ...
    <div class="o-text-section">
      ...
      <l-wrapper size="sm">
        ...
        <p class="o-text o-text--paragraph">Now on to the actual task... to present some data from the dashboard in an interesting manner. Again I stuck to what I know and went 'web'. Check out the live demo <f-link externalLink="https://thisguyscode.github.io/rte-comparison/" :inline="true">here.</f-link> The idea was that it could feature a selection of the top insights from the dashboard and serve as a shareable promotion piece. I just took one insight given the time contraint but it was enough to illustrate the concept.</p>
      </l-wrapper>
    </div>
